...
- `Snapshot`에는 `Requirements Status`, `Requirement Baseline`, `Requirements Sync Check`, `Architecture Status`, `Plan Status`, `Current Green Level`, `Branch Freshness`, `Last Synced From Task / Handoff`, `Sync Checked At`를 채웁니다.
