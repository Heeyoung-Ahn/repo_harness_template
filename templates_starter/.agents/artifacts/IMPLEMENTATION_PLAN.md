...
- 이번 iteration의 Requirement IDs: `FR-01`~`FR-07`, `NFR-01`~`NFR-05`
...
- enterprise-governed pack / governance control check: pack activation prerequisite와 dry-run/reporting defer policy를 요구사항에 명시한다
- 현재 green level target: `Targeted`
- branch freshness precheck: starter baseline을 프로젝트 요구사항에 맞게 먼저 정리한다
- user-captured manual test expected: none in kickoff
...
- Main Task IDs: `DEV-03`, `DEV-04`, `TST-02`, `REV-01`, `REL-02`
- Requirement IDs: `FR-05`~`FR-07`, `NFR-04`, `NFR-05`
- Validation focus: read-only boundary, `.omx/*` not-truth, actual rollout deferred
...
- 수동 / 실환경 gate: optional visibility smoke, dry-run/report output review, 사용자 raw report alignment
