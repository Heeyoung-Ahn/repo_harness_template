...
- Optional Runtime Boundary Check: Pass / Fail / Not Applicable
- Enterprise / Critical-Domain Gate: Pass / Fail / Not Applicable
- Dry-Run / Reporting Readiness: Ready / Blocked / Not Applicable
- Reviewer:
- Reviewed At:
...
|---|---|---|---|---|
| REV-01 | High | Architecture / Security / Quality / Governance | [설명] | Developer / Planner |
...
- Deferred product decisions / rollout decisions:
